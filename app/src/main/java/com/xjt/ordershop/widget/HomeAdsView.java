...
public class HomeAdsView extends LinearLayout {
    ...
    public void setAdsResource(List<Integer> list) {
        ...
        ImageLoader.getInstance().displayImage("drawable://" + list.get(0), ads1);
        ImageLoader.getInstance().displayImage("drawable://" + list.get(1), ads2);
        ImageLoader.getInstance().displayImage("drawable://" + list.get(2), ads3);
        ImageLoader.getInstance().displayImage("drawable://" + list.get(3), ads4);
    }
    ...
    public void setAdsUrl(List<String> list) {
        ...
        ImageLoader.getInstance().displayImage(list.get(0), ads1);
        ImageLoader.getInstance().displayImage(list.get(1), ads2);
        ImageLoader.getInstance().displayImage(list.get(2), ads3);
        ImageLoader.getInstance().displayImage(list.get(3), ads4);
    }
